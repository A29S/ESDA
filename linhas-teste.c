...
int verifica_pesquisa_avancada(grafo *g)
{
    ...
    int n = 0;
    vno = pesquisa_avancada(g, "Alvalade",  &n);
...
int verifica_estacoes_distrito(grafo *g)
{
    ...
    int n = 0;
    vno = estacoes_distrito(g, "sksjj",  &n);
...
int verifica_estacoes_linha(grafo *g)
{
    ...
    int n = 0;
    vno = estacoes_linha(g, "Leixões",  "Linha de Leixões",&n);
...
int verifica_metros_linha(grafo *g)
{
    ...
    vno = metros_linha(g,  "Linha de Leixões", "Leixões");
